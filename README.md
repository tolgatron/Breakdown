# <span style="font-size:1.25em; color:#025249"> Teamfight Tactics by Riot Games - Breakdown
This document is created by Tolga Coşkun. This document is based on the dekstop version of Teamfight Tactics. Mobile and Desktop version only differ in UI/UX in the respectable platform's context.
<p align="center">
<img src=./TeamFightLogo.png>
</p>

<span style="color:#007C6F">**Name** : </span>
Teamfight Tactics <br/>
<span style="color:#007C6F">**Release Date** : </span>
June 2019 (PC, macOS) - March 2020 (Android, iOS) <br/>
<span style="color:#007C6F">**Platform** : </span>
Cross Platform between Desktop and Mobile <br/>
<span style="color:#007C6F">**Genre** : </span>
Auto Battler <br/>
<span style="color:#007C6F">**Monetiztion Methods** : </span> 
Cosmetics Sales, Battle Pass(Cosmetics) <br/>
<span style="color:#007C6F">**Examplary Games** : </span>
DOTA Auto Chess, Conventional Chess & Mahjong<br/>
...
## <span style="font-size:1.25em; color:#025249"> Gameplay </span>
---
...
### <span style="color:#025249"> Arena </span>
...
<p align="center">
<img src=./ArenaDiagram.png>
</p>

<br/>

### <span style="color:#025249"> Phases & Combat </span>
...
### <span style="color:#025249"> Stages & Rounds </span>
...
### <span style="color:#025249"> Damage & Standings </span>
...
<p align="center">
<img src=./Standings.png width="120">
</p>
...
<p align="center">
<img src=./DamageDealt.png width="120">
</p>
...
## <span style="font-size:1.25em; color:#025249"> Economy </span>
---
...
### <span style="color:#025249"> Champions </span>

<p align="center">
<img src=./ChampionInventory.png>
</p>
...
|-----------------|--------|---------|---------|---------|---------|
| 1 Star (Bronze)        | 1 Gold | 2 Gold  | 3 Gold  | 4 Gold  | 5 Gold  |
| 2 Star (Silver) | 3 Gold | 6 Gold  | 9 Gold  | 12 Gold | 15 Gold |
| 3 Star (Gold)   | 9 Gold | 18 Gold | 27 Gold | 36 Gold | 45 Gold |

<br/>
<p align="center">
<img src=./ChampionPool2.png>
</p>
...
### <span style="color:#025249"> Currencies </span>
...
<table>
<tr><th>Gold Income from Interest </th><th>Gold Income from Streaks</th></tr>
<tr><td>

| Gold Amount | Gold Obtained |
|:-----------:|:------------------------:|
|      10     |            +1            |
|      20     |            +2            |
|      30     |            +3            |
...
| Streaks/Win Lose | Gold Obtained |
|:----------------:|:-------------:|
|        2-3       |       +1      |
|         4        |       +2      |
|         5        |       +3      |
...
| Rarity/Level | Level 1 | Level 2 | Level 3 | Level 4 | Level 5 | Level 6  | Level 7 | Level 8 |   Level 9   |
|:------------:|:-------:|:-------:|:-------:|:-------:|:-------:|:--------:|:-------:|:-------:|:-----------:|
|    Tier 1    |   %100  |   %100  |   %75   |   %55   |   %45   |    %30   |   %19   |   %14   |     %10     |
|    Tier 2    |    %0   |    %0   |   %25   |   %30   |   %30   |    %35   |   %35   |   %20   |     %15     |
|    Tier 3    |    %0   |    %0   |    %0   |   %15   |   %20   |    %25   |   %30   |   %35   |     %30     |
|    Tier 4    |    %0   |    %0   |    %0   |    %0   |    %5   |    %10   |   %15   |   %25   |     %30     |
|    Tier 5    |    %0   |    %0   |    %0   |    %0   |    %0   |    %0    |    %1   |    %6   |     %15     |
|  Exp Needed  |  START  |   2XP   |   6XP   |   10XP  |   20XP  |   36XP   |   56XP  |   80XP  | Total 210XP |
...
### <span style="color:#025249"> Items </span>
...
## <span style="font-size:1.25em; color:#025249"> Monetization </span>
----
...
## <span style="font-size:1.25em; color:#025249"> Proposed Improvements & Hurdles </span>
----
...
### <span style="color:#025249"> Single-Use Consumables </span>
...
### <span style="color:#025249"> Wildcard Items </span>
...
### <span style="color:#025249"> One RNG Champion each round - Different Game mode </span>

Currently games can last up to 40-50 minutes in Teamfight Tactics if players perform well in the game. To cater to people with time constraints, we can introduce a different game mode. Core gameplay and economy meta will fundamentally stay the same but we can introduce a small twist; Random one extra champion at the start of each PvP round depending on player's level. With the introduction of this mode our aim is to create a shorter game experience while being robust as well.

* If the player has a full champion inventory, they take the cost of the champion as damage
...
This mode can only be an experimental mode in Public Beta Environment until we recieve feedback from QA team.

### <span style="color:#025249"> Shared Draft Wishlist </span>
...
### <span style="color:#025249"> General QoL Changes </span>
